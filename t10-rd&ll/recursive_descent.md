...
Наиболее интуитивный способ нисходящего анализа. Он опирается на то, мы можем написать набор рекурсивных функций для нашей грамматики, а стеком распознавателя будет стек вызовов программы. F(substr, word) --> (result, tail(word)).
