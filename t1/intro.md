...
Как было отмечено ранее, задачу проверки принадлежности слова языку можно решать, строя некоторый формальный вычислитель, способный за конечное время дать ответ "да", если слово принадлежит языку, иначе нет, и подавая ему на вход тестируемое слово. Такой вычислитель называется распознавателем слова.
